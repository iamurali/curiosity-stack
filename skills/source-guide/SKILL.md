...
name: source-guide
description: >
  Activate when user asks where to find information at any layer, or when they are
  stuck and need pointers to go deeper. Always check connected personal sources first.
---
